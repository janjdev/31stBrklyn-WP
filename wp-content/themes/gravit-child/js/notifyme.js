...
(function($){
	...
	$.fn.notifyMe = function($position, $type, $title, $content, $velocity, $delay){
		...
		var header = "<section class='notify' data-position='"+ $position +"' data-notify='" + $type + "'>" + close + "<div class='notifytext'>" + " <h3>" + $title + "</h3>";
		var content =  "<div class='notify-content'>" + prepareContent($content) + "</div> </div> </section>";
